...
export async function generateDisputeLetters(reportId, userId, analysis) {
    ...
    for (const bureau of BUREAUS) {
        try {
            ...
            // 4) Save to DB
            await pool.query(`insert into dispute_letters (report_id, user_id, bureau, file_key, content_text)
                 values ($1, $2, $3, $4, $5)`, [reportId, userId, bureau, fileKey, contentText]);
